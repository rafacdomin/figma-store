<template>
  <div class="">
    <div class="flex border-b-4 border-black [&>*]:stroke-black [&>*]:stroke-[4]">
      ...
      <div>
        <a href="/products/gridlock-washi-tape">
          <div>Gridlock washi tape</div>
      ...
      <div>
        <a href="/products/design-in-bloom-tee">
          <div>Design in bloom tee</div>
      ...
      <div>
        <a href="/products/dress-code-hat">
          <div>Dress code hat</div>
      ...
      <div>
        <a href="/products/shape-up-tee">
          <div>Shape up tee</div>
      ...
      <div>
        <a href="/products/band-together-socks">
          <div>Band together socks</div>
      ...
      <div>
        <a href="/products/framework-tee">
          <div>Framework tee</div>
    ...
    <div class="flex justify-between absolute top-1/2 w-full">
      <button class="opacity-0 hover:opacity-100 duration-300 transition-all px-5 py-8 h-full">
        <svg
          class="svg-arrow"
          width="25"
          height="20"
        ...
        >
          <path
            d="M24.416 11.136V8.064H5.792L8.48 5.408L11.776 2.144L9.6 0L0 9.6L9.6 19.2L11.776 17.056L8.48 13.792C7.552 12.896 6.688 12.032 5.792 11.136H24.416Z"
            fill="black"
          ></path>
        </svg>
      </button>
      <button class="opacity-0 hover:opacity-100 duration-300 transition-all px-5 py-8 h-full">
        ...
        >
          <path
            d="M0.583984 8.064V11.136H19.208C18.28 12.032 17.416 12.928 16.52 13.824L13.224 17.056L15.4 19.2L25 9.6L15.4 0L13.224 2.144L16.52 5.408C17.416 6.304 18.28 7.168 19.208 8.064H0.583984Z"
            fill="black"
          ></path>
        </svg>
      </button>
